...
export default function SmartContractDemo() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Trade property NFTs',
      icon: TrendingUp,
      color: 'text-red-600',
    },
    {
    ...
    <Box className="min-h-screen bg-background">
      ...
      <Box className="flex">
              ...
              return (
                <Button
                  ...
                  className={`w-full justify-start gap-3 ${
                    isActive ? 'bg-gradient-primary text-white' : 'hover:bg-gray-100'
                ...
                >
                  ...
                  {isSidebarOpen && (
                    <Box className="flex-1 text-left">
                      ...
                      {!isActive && (
                        <Box className="text-xs text-muted-foreground">{item.description}</Box>
                      )}
                    </Box>
                  )}
        ...
        <Box className={`flex-1 transition-all duration-300 ${isSidebarOpen ? '' : 'lg:ml-20'}`}>
          {/* Mobile Menu Button */}
          <Box className="lg:hidden p-4 border-b border-gray-200">
            <Button
              variant="outline"
              size="sm"
