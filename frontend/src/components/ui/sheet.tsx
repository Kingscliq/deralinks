...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-sidebar-primary/10 absolute top-4 right-4 rounded-lg p-2 opacity-70 hover:opacity-100 hover:bg-sidebar-primary/20 transition-all duration-300 focus:ring-2 focus:ring-sidebar-primary focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
          <XIcon className="size-5 text-sidebar-foreground" />
